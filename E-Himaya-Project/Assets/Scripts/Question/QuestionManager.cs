...
public class QuestionManager : MonoBehaviour
{
    ...
    {
        WeightedTransformArray _WeightedTransformArray = _MultiAimConstraint.data.sourceObjects;
        _WeightedTransformArray.SetWeight(0, 0f);
        _WeightedTransformArray.SetWeight(1, 1f);
        _MultiAimConstraint.data.sourceObjects = _WeightedTransformArray;
